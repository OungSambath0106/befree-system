                                                    ...
                                                    @if ($lang['status'] == 1)
                                                        <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3" id="lang_{{ $lang['code'] }}" role="tabpanel" aria-labelledby="lang_{{ $lang['code'] }}-tab">
                                                            <div class="form-group">
                                                                ...
                                                                <label class="required_label" for="title_{{ $lang['code'] }}">{{ __('Title') }}({{ strtoupper($lang['code']) }})</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="required_label" for="description_{{ $lang['code'] }}">{{ __('Description') }}({{ strtoupper($lang['code']) }})</label>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6" hidden>
                                            <label class="required_label" for="amenities">{{__('Category')}}</label>
                                        ...
                                        <div class="form-group col-md-6" hidden>
                                            <label class="required_label" for="amenities">{{__('Tags')}}</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <input type="file" class="custom-file-input_thumbnail" id="thumbnail" name="image" accept="image/png, image/jpeg">
