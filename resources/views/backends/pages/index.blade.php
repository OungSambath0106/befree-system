                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-primary btn-modal float-right" href="#" data-href="{{ route('admin.pages.create') }}" data-toggle="modal" data-container=".modal_form">
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.menu.update_status') }}",
