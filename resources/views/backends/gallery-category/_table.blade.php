            ...
            @foreach ($categories as $category)
                <tr>
                    ...
                    <td>
                        ...
                        @if (auth()->user()->can('gallery-category.edit'))
                            <a href="#" data-href="{{ route('admin.gallery-category.edit', $category->id) }}"
                        ...
                        @if (auth()->user()->can('gallery-category.delete'))
                            <form action="{{ route('admin.gallery-category.destroy', $category->id) }}"
                                class="d-inline-block form-delete-{{ $category->id }}">
                                @csrf
                                @method('DELETE')
                                <button type="submit" data-id="{{ $category->id }}"
                                    data-href="{{ route('admin.gallery-category.destroy', $category->id) }}"
