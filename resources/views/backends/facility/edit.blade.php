                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="tab-content" id="custom-content-below-tabContent">
                                            @foreach (json_decode($language, true) as $key => $lang)
                                                @if ($lang['status'] == 1)
                                                <?php
                                                            if (count($facility['translations'])) {
                                                                $translate = [];
                                                                foreach ($facility['translations'] as $t) {
                                                    ...
                                                    <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="title" id="title_{{ $lang['code'] }}"
                                                                ...
                                                                value="{{ $translate[$lang['code']]['title'] ?? $facility['title'] }}">
                                                            @error('title')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="description_{{ $lang['code'] }}" class="form-control @error('description') is-invalid @enderror"
                                                                name="description[]" placeholder="{{ __('Enter Description') }}" rows="4">{{ $translate[$lang['code']]['description'] ?? $facility['description'] }}</textarea>
                                                            @error('description')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ $facility->thumbnail ?? __('Choose Thumbnail') }}</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ $facility->image ?? __('Choose Image') }}</label>
                                                </div>
                                            </div>
                                            <div class="preview text-center border rounded mt-2" style="height: 180px">
                                                <img class="py-2" src="
