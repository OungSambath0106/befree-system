                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Staycation List') }}</h3>
                            </div>
                            
                            <div class="col-sm-6">
                                @if (auth()->user()->can('staycation.create'))                                    
                                <a class="btn btn-primary float-right" href="{{ route('admin.staycation.create') }}">
                    ...
                    {{-- table --}}
                    @include('backends.staycation._table')
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.staycation.update_status') }}",
