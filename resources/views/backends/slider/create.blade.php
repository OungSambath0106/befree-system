                                                        ...
                                                        <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3" id="lang_{{ $lang['code'] }}" role="tabpanel" aria-labelledby="lang_{{ $lang['code'] }}-tab">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="short_des" id="short_des_{{ $lang['code'] }}" class="form-control @error('short_des') is-invalid @enderror"
                                                                    name="short_des[]" placeholder="{{__('Enter Short Description')}}" value="">
                                                                @error('short_des')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <select class="form-control @error('type') is-invalid @enderror" name="type" required>
                                                ...
                                                <option value="company_info">{{__('Home Chaufea')}}</option>
                                                <option value="villas">{{__('Villas')}}</option>
                                                <option value="experience">{{__('Experience')}}</option>
                                                <option value="offers">{{__('Offers')}}</option>
                                                <option value="the_property">{{__('The Property')}}</option>
                                                <option value="gallery">{{__('Gallery')}}</option>
                                                <option value="foundation">{{__('Foundation')}}</option>
                                                <option value="about">{{__('About Us')}}</option>
                                                <option value="contact">{{__('Contact Us')}}</option>
                                                <option value="booking_history">{{__('Booking History')}}</option>
                                            </select>
                                            @error('type')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
