                                                        ...
                                                        <?php
                                                            if (count($service['translations'])) {
                                                                ...
                                                                foreach ($service['translations'] as $t) {
                                                                    ...
                                                                    if ($t->locale == $lang['code'] && $t->key == "extra_info") {
                                                                        $translate[$lang['code']]['extra_info'] = $t->value;
                                                                    }
                                                        ...
                                                        <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3" id="lang_{{ $lang['code'] }}" role="tabpanel" aria-labelledby="lang_{{ $lang['code'] }}-tab">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="title_{{ $lang['code'] }}" class="form-control @error('title') is-invalid @enderror"
                                                                    name="title[]" placeholder="{{__('Enter Title')}}" value="{{ $translate[$lang['code']]['title'] ?? $service['title'] }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea id="description_{{ $lang['code'] }}" class="form-control @error('description') is-invalid @enderror"
                                                                    name="description[]" rows="5">{{ $translate[$lang['code']]['description'] ?? $service['description'] }}</textarea>
                                                                    @error('description')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="hidden" name="thumbnail_image_names" class="thumbnail_image_names_hidden">
                                                        <input type="file" class="custom-file-input-thumbnail" id="exampleInputFile" name="image" accept="image/png, image/jpeg">
                                                        <label class="custom-file-label" for="exampleInputFile">{{ $service->thumbnail ?? __('Choose file') }}</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        ...
                                                        <input type="file" class="custom-file-input" id="exampleInputFile" name="image[]" multiple accept="image/png, image/jpeg">
                                                        <label class="custom-file-label" for="exampleInputFile">{{ __('Choose file') }}</label>
                                                    </div>
                                                </div>
                                                <div class="preview  preview-multiple text-center border rounded mt-2" style="height: 150px">
                                                    <div class="update_image">
                                                        @if (@$service_gallery->image == null)
                                                            <img src="{{ asset('uploads/image/default.png') }}" alt="" height="100px">
                                                        @else
                                                            @foreach (@$service_gallery->image as $image)
                                                                <div class="img_container">
                                                                    <img src="{{ asset('uploads/service_gallery/' . $image) }}" height="100px" alt="">
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                    </div>
