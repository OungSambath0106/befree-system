                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Highlight List') }}</h3>
                            </div>
                            <div class="col-sm-6">
                                @if (auth()->user()->can('highlight.create'))                                    
                                <a class="btn btn-primary float-right" href="{{ route('admin.highlight.create') }}">
                    ...
                    @include('backends.highlight._table')
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.highlight.update_status') }}",
