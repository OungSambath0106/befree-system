        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-primary btn-modal float-right" href="#" data-href="{{ route('admin.gallery.create') }}" data-toggle="modal" data-container=".modal_form">
                    ...
                    @include('backends.gallery._table')
                </div>
            </div>
        </div>
    </div>
