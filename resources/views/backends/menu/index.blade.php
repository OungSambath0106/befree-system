                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-primary btn-modal float-right" href="#" data-href="{{ route('admin.menu.create') }}" data-toggle="modal" data-container=".modal_form">
