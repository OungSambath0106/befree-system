    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                    <form method="POST" action="{{ route('admin.section_title.store') }}" enctype="multipart/form-data">
                        @csrf
                                                    ...
                                                    <div class="tab-pane fade {{ $lang['code'] == $default_lang ? 'show active' : '' }} mt-3"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="default_title_{{ $lang['code'] }}"
                                                                ...
                                                                name="default_title[]" placeholder="{{ __('Enter Default Title') }}"
                                                                value="">
                                                            @error('default_title')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="card no_translate_wrapper">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <select name="page_id" id="page_id" class="form-control" readonly>
