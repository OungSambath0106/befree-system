                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Amenity List') }}</h3>
                            </div>
                            {{-- <div class="col-sm-6">
                                <a class="btn btn-primary float-right" href="{{ route('admin.amenities.create') }}">
                    ...
                    @include('backends.amenity._table')
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.amenities.update_status') }}",
