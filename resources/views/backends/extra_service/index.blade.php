                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-sm-6">
                                <h3 class="card-title">{{ __('Extra Services List') }}</h3>
                            </div>
                            <div class="col-sm-6">
                                @if (auth()->user()->can('extra_service.create'))
                                <a class="btn btn-primary float-right" href="{{ route('admin.extra-service.create') }}">
                    ...
                    @include('backends.extra_service._table')
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.extra-service.update_status') }}",
