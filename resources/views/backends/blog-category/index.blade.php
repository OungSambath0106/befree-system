        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-primary btn-modal float-right" href="#" data-href="{{ route('admin.blog-category.create') }}" data-toggle="modal" data-container=".modal_form">
                    ...
                    {{-- table --}}
                    @include('backends.blog-category._table')
...
<script>
    ...
    $('input.status').on('change', function () {
        ...
        $.ajax({
            type: "get",
            url: "{{ route('admin.blog-category.update_status') }}",
