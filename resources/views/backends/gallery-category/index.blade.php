                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-6">
                                    {{-- <a href="{{ au }}"></a> --}}
                                    {{-- <a class="btn btn-primary float-right" href="{{ route('admin.gallery-category.create') }}">
                                    <i class=" fa fa-plus-circle"></i>
                                    {{ __('Add New') }}
                                </a> --}}
                                    @if (auth()->user()->can('gallery-category.create'))
                                        <a class="btn btn-primary btn-modal float-right" href="#"
                                            data-href="{{ route('admin.gallery-category.create') }}" data-toggle="modal"
                        ...
                        {{-- table --}}
                        @include('backends.gallery-category._table')
...
@push('js')
    <script>
        ...
        $('input.status').on('change', function() {
            ...
            $.ajax({
                type: "get",
                url: "{{ route('admin.gallery-category.update_status') }}",
                data: {
                    "id": $(this).data('id')
                },
                dataType: "json",
